...
const StatisticsTable: React.FC<StatisticsTableProps> = ({ year }) => {
    ...
    const [modalData, setModalData] = useState<{ type: string; month: string; year: string } | null>(null)

    const handleOpenModal = (type: string, month: string, year: string) => {
                                ...
                                {[
                                    ...
                                    <TableCell key={type} align="center">
                                        <Button
                                            variant="text"
                                            size="small"
                                            onClick={() => handleOpenModal(type, row.month, row.year)}
                                            sx={{
                                                padding: '2px 5px',
                                                fontSize: '0.75rem',
                                                '&:hover': {
